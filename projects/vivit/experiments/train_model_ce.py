...
def main():
    ...
    net, _ = train(
        ...
        lam=1.0, 
        patience=25, 
        log_file="epochs100_td4_position_lr1e4_dicece_onecycle_lam10_128x128x64_0714"
    )

    path = "epochs100_td4_position_lr1e4_dicece_onecycle_lam10_128x128x64_0714_embedding.pth"
