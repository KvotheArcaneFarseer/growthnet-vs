...
def main():
    ...
    net, _ = train(
        ...
        lam=1.0, 
        patience=200, 
        log_file="epochs200_td4_dual_cat_lr1e4_tverskyce_warmup_lam10_128x128x64_1020_pretrain_new"
    )

    path = "epochs200_td4_daul_cat_lr1e4_tverskyce_warmup_lam10_128x128x64_1020_pretrain_new_embedding.pth"
