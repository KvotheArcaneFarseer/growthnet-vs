...
def main():
    ...
    net, _ = train(
        ...
        lam=1.0, 
        patience=25, 
        log_file="epochs100_td4_position_lr1e4_tverskyce_warmup_lam10_128x128x64_1020_nopretrain"
    )

    path = "epochs100_td4_position_lr1e4_tverskyce_warmup_lam10_128x128x64_1020_nopretrain_embedding.pth"
